...
let appData = {
    ...
    getBudget: function() {
        this.budgetMonth = this.budget + this.incomeMonth - this.expensesMonth + (this.moneyDeposit * this.percentDeposit) / 12, //в эту строку нужно будет добавить за Максимом
